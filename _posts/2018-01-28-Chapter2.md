...
**(a)**: Let $p_b$ be the probability $\mathcal{A}$ outputs 1 in its nested encryption game, we could observe that $Pr[W_0]=p_0, Pr[W_1]=p_1$, thus $SSadv[\mathcal{B}, \mathcal{E}] = \|p_0-p_1\| = NEadv[\mathcal{A}, \mathcal{E}]$. {%sidenote "2-15" "TODO: add MetaPost script graph"%}


**(b)**: {%sidenote "2-15" "TODO: add MetaPost script graph"%}
